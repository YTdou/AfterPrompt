...
<p align="center">
  <a href="https://47.237.77.35/last-mile-studio/"><strong>在线体验</strong></a> ·
  <a href="#快速开始">本地运行</a> ·
...
> 当前版本为可运行的 MVP（0.4.0）。`/AfterPrompt/` 路由已完成部署准备；迁移完成前，[当前在线 Demo](https://47.237.77.35/last-mile-studio/) 仍是已验证入口。
