...
<p align="center"><strong>面向 AI 生成 HTML、演示稿与 SVG 的源码优先可视化编辑器。</strong></p>

<p align="center">直接编辑真实 DOM / SVG，检查可读源码，并导出标准文件。</p>

<p align="center">
  <a href="https://redacted.invalid/last-mile-studio/"><strong>在线体验</strong></a> ·
  <a href="#快速开始">本地运行</a> ·
  <a href="examples/">查看示例</a>
</p>

<p align="center">
  <img src="docs/screenshots/afterprompt-hero.png" alt="AfterPrompt 正在编辑一份 AI 生成的 HTML 演示页：画布中选中了真实 DOM 元素，同时仍可访问文档结构和源码。" width="100%" />
</p>

<p align="center"><a href="README.md">English</a> · <b>简体中文</b></p>

> 当前版本为可运行的 MVP（0.4.0）。`/AfterPrompt/` 路由已完成部署准备；迁移完成前，[当前在线 Demo](https://redacted.invalid/last-mile-studio/) 仍是已验证入口。

## AfterPrompt 是什么？

AI 可以快速生成网页、演示稿或 SVG，但最后的视觉修改往往只能在手写代码和不透明设计格式之间选择。AfterPrompt 让标准 HTML / SVG 始终处于工作流中心：导入成果、在真实节点上完成视觉精修、检查底层源码，然后预览或导出标准文件。

```text
在其他工具中生成 → 在 AfterPrompt 中完成视觉收尾 → 保留并导出标准源码
```
